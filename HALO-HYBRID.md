...
| + 32-wave KDA, WMMA flash attention for D=512 on both parts (b31153b08) | **283** / 20.0 | **264** / 19.7 |
...
- **Open: TOPK_MOE fails one random case per full test-backend-ops run** at the 1e-7 tolerance (ERR 1e-5..4e-4, a different
  small-expert-count shape each time: 31, 40, 129, 256 experts; the 288-expert GLM shapes pass). Seen on the R9700 at d0671bd
  before any of the halo-box ports and on mainframe's gfx1151 at b31153b08; a TOPK_MOE-only run passes 416/416. It predates
