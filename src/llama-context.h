...
struct llama_context {
    ...
    uint32_t n_prefill_lanes() const; // halo-hybrid
...
private:
    ...
    // halo-hybrid: a remote (RPC) device is present; with two lanes the prefill runs as a rolling pipeline
    bool has_remote_backend = false;
