...
public:
    ...
    // halo-hybrid: per-cell position for ggml_kq_mask_build (-1: empty or not the ubatch's one sequence)
    void set_input_pos_kv    (ggml_tensor * dst, const llama_ubatch * ubatch) const;
